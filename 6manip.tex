...
\pagebreak
\marginnote[12pt]{The argument \txtt{breaks} can be either the number of
...
Use a command of the form \txtt{rm(x, y, tmp)} to remove
...
that use \txtt{apply()}. Here are timings for alternatives that
find the sums of rows of the matrix \txtt{xy} that was generated thus:
\begin{Schunk}
\begin{Sinput}
