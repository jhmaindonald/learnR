...
\begin{alltt}
\hlkwd{read_chunk}\hlstd{(}\hlstr{"../scripts/lever-code.R"}\hlstd{)}
\end{alltt}


{\ttfamily\noindent\color{warningcolor}{\#\# Warning in file(con, "{}r"{}): cannot open file '../scripts/lever-code.R': No such file or directory}}
