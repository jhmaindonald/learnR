...
\begin{marginfigure}
<<fVSmTime, echo=FALSE, out.width="0.98\\textwidth">>=
@ %
...
<<mfdensity, eval=FALSE>>=
@ %

\paragraph{Logarithmic scales:}

\begin{marginfigure}[-72pt]
<<rec-logmf, echo=FALSE, w=3, h=3, out.width="0.98\\textwidth">>=
@ %
<<skewtime-log, echo=FALSE, w=3, h=3, out.width="0.98\\textwidth">>=
@ %
...
<<rec-logmf, eval=FALSE>>=
@ %
\noindent
Simplified code for the lower panel is:
<<skewtime-log, eval=FALSE>>=
@ %
...
\begin{figure}
<<tohoriz-mf, echo=FALSE, mfrow=c(1,2), w=6, h=3, top=2, bot=0.5, left=1>>=
@ %
...
\begin{figure*}
<<diag-mf, echo=FALSE, mfrow=c(1,4), w=8, h=2, top=1.5,  right=1>>=
@ %
...
@ %
\begin{figure*}
<<diag-logmf, echo=FALSE, mfrow=c(1,4), w=8, h=2, top=1.5,  right=1>>=
@ %
...
\begin{figure}
<<termplot-aovAB, echo=FALSE, mfrow=c(1,2), w=6.5, h=2.75>>=
<<termplot-aov-wt>>
<<termplot-aov-logwt>>
@ %
...
\begin{figure}
<<tplot-ni, echo=FALSE, mfrow=c(1,2), w=6, h=3,bot=0.5, left=1>>=
@ %
...
\begin{figure}[h]
<<elec-me-tplot, echo=FALSE, mfrow=c(2,4), w=8, h=4>>=
@ %
...
\begin{figure*}
<<bronchitAB, echo=FALSE, w=7.5, h=3.75, mfrow=c(1,2)>>=
<<bronchit-ylim>>
<<bronchitA>>
<<bronchitB>>
@ %
...
\begin{figure}[h]
<<cig2-tplot, echo=FALSE, mfrow=c(1,2), w=6, h=3>>=
@ %
