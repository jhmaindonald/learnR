...
<<echo=FALSE, cache=FALSE>>=
Hmisc::knitrSet()
Hmisc::knitrSet(w=3.15, h=3.15)
opts_chunk$set(fig.path='figs/04-', cache.path='cache/04-',
               fig.align='center', dev='pdf',  
               fig.show='hold', out.width="0.47\\textwidth", 
               tidy=FALSE, comment=NA)
pdf.options(pointsize=12)
oldopt <- options(digits=4)
read_chunk("../scripts/data-code.R")
@ 
...
<<place-travelbooks, results="hide", echo=FALSE>>=
@ %
...
The data frame \code{DAAG::ais} has physical charateristics
...
<<list-details, eval=FALSE>>=
@ %

<<list-details, echo=FALSE>>=
@ %
...
<<molclock1-in, eval=TRUE, echo=TRUE, results="hide">>=
@ %
\end{marginfigure}
...
<<date-labs,eval=TRUE, echo=FALSE, out.width="0.97\\textwidth">>=
@ %
...
\vspace*{-9pt}
<<bubble, echo=FALSE, w=4, h=4, out.width="\\textwidth">>=
@ %
