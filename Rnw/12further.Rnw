...
opts_chunk$set(fig.path='figs/12-', cache.path='cache/12-',
...
\begin{marginfigure}
<<smooth-ohms, echo=FALSE, w=2.5, h=2.0, out.width="0.98\\textwidth">>=
@ %
...
\begin{fullwidth}
\begin{figure*}
<<plotVIS, w=8.5, h=3.5, mfrow=c(1,2), top=2, out.width="0.97\\textwidth", echo=FALSE>>=
@ %
...
\begin{marginfigure}
<<ant111b, echo=FALSE, w=3, h=2.65, out.width="0.98\\textwidth">>=
@ %
...
@ %
\begin{figure}
<<mdb-gam, echo=FALSE, warning=FALSE, w=7.5, h=3.75, top=2,  mfrow=c(1,2)>>=
@ %
...
\begin{figure*}
<<ar1sims, echo=FALSE, warning=FALSE, w=6.5, left=1, h=3, mfrow=c(2,3), out.width="0.97\\textwidth">>=
@ %
...
\begin{figure*}
\vspace*{-12pt}
<<plotGAM, w=8.5, h=3.5, mfrow=c(1,2), top=2, out.width="0.97\\textwidth", echo=FALSE>>=
@ %
\vspace*{-6pt}
...
\begin{figure}
<<fgl-scores2D, eval=TRUE, echo=FALSE, w=5, h=3.5, cache=FALSE, out.width="0.85\\textwidth">>=
@ %
...
\begin{figure}
<<rf-x-bronchit, echo=FALSE, w=7, h=4.5, mfrow=c(3,4)>>=
@ %
...
\begin{marginfigure}
<<aupoints, eval=T, echo=F, w=3.75, h=3.25, left=-2, rt=3, out.width="0.98\\textwidth">>=
@ %
...
\begin{figure*}[h]
<<au-both, echo=FALSE, w=5.5, h=4.5, out.width="0.47\\textwidth">>=
<<au-overlay>>
mtext(side=3, line=0.5, adj=0, "A: Using Classical MDS")
<<au-sammon>>
mtext(side=3, line=0.5, adj=0, "B: Using Sammon Scaling")
@ %
