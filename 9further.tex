...
\centerline{\includegraphics[width=\textwidth]{figs/12-mdb-gam-1} }
...
\centerline{\includegraphics[width=0.98\textwidth]{figs/12-plotGAM-byWk-1} }
...
\centerline{\includegraphics[width=0.9\textwidth]{figs/12-fgl-scores2D-1} }
...
\centerline{\includegraphics[width=0.85\textwidth]{figs/12-rf-x-bronchit-1} }
